...
const (
	ToolService_ListTools_FullMethodName = "/tools.v1.ToolService/ListTools"
	ToolService_Execute_FullMethodName   = "/tools.v1.ToolService/Execute"
)
...
var ToolService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "tools.v1.ToolService",
