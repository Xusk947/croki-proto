...
const (
	...
	AuthService_GetAuthSession_FullMethodName    = "/croki.auth.v1.AuthService/GetAuthSession"
)
...
func (c *authServiceClient) GetAuthSession(ctx context.Context, in *GetAuthSessionRequest, opts ...grpc.CallOption) (*GetAuthSessionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetAuthSessionResponse)
	err := c.cc.Invoke(ctx, AuthService_GetAuthSession_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAuthServiceServer) GetAuthSession(context.Context, *GetAuthSessionRequest) (*GetAuthSessionResponse, error) {
...
func _AuthService_GetAuthSession_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_GetAuthSession_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).GetAuthSession(ctx, req.(*GetAuthSessionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
